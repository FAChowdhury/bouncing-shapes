...
#include "imgui.h" // if we have issues, change this to #include <imgui.h>
...
namespace ImGui
{
	namespace SFML
	{
		...
		{
			auto found =
			    std::find_if(s_windowContexts.begin(), s_windowContexts.end(), [&](std::unique_ptr<WindowContext>& ctx) {
...
#	pragma GCC diagnostic pop
		...
		void Update(sf::Window& window, sf::RenderTarget& target, sf::Time dt)
		{
			...
			const ImGuiMouseCursor mouse_cursor = ImGui::GetIO().MouseDrawCursor ? ImGuiMouseCursor_None
...
#	endif
		...
		void SetJoystickMapping(int key, unsigned int joystickButton)
		{
			...
			switch (key)
			{
			case ImGuiNavInput_Activate: finalKey = ImGuiKey_GamepadFaceDown; break;
			case ImGuiNavInput_Cancel: finalKey = ImGuiKey_GamepadFaceRight; break;
			case ImGuiNavInput_Input: finalKey = ImGuiKey_GamepadFaceUp; break;
			case ImGuiNavInput_Menu: finalKey = ImGuiKey_GamepadFaceLeft; break;
			case ImGuiNavInput_FocusPrev:
			case ImGuiNavInput_TweakSlow: finalKey = ImGuiKey_GamepadL1; break;
			case ImGuiNavInput_FocusNext:
			case ImGuiNavInput_TweakFast: finalKey = ImGuiKey_GamepadR1; break;
			default:
	...
	void
	Image(const sf::Texture& texture, const sf::Vector2f& size, const sf::Color& tintColor, const sf::Color& borderColor)
	{
	...
	void
	Image(const sf::Sprite& sprite, const sf::Vector2f& size, const sf::Color& tintColor, const sf::Color& borderColor)
	{
	...
	void
	DrawRect(const sf::FloatRect& rect, const sf::Color& color, float rounding, int rounding_corners, float thickness)
	{
		ImDrawList* draw_list = ImGui::GetWindowDrawList();
...
namespace
{
	...
	void
	updateJoystickAxis(ImGuiIO& io, ImGuiKey key, sf::Joystick::Axis axis, float threshold, float maxThreshold, bool inverted)
	{
	...
	void
	updateJoystickAxisPair(ImGuiIO& io, ImGuiKey key1, ImGuiKey key2, sf::Joystick::Axis axis, float threshold, bool inverted)
	{
	...
	ImGuiKey keycodeToImGuiKey(sf::Keyboard::Key code)
	{
		...
		case sf::Keyboard::Quote: return ImGuiKey_Apostrophe;
		case sf::Keyboard::Comma: return ImGuiKey_Comma;
		case sf::Keyboard::Hyphen: return ImGuiKey_Minus;
		case sf::Keyboard::Period: return ImGuiKey_Period;
		case sf::Keyboard::Slash: return ImGuiKey_Slash;
		case sf::Keyboard::Semicolon: return ImGuiKey_Semicolon;
		case sf::Keyboard::Equal: return ImGuiKey_Equal;
		case sf::Keyboard::LBracket: return ImGuiKey_LeftBracket;
		case sf::Keyboard::Backslash: return ImGuiKey_Backslash;
		case sf::Keyboard::RBracket: return ImGuiKey_RightBracket;
		case sf::Keyboard::Tilde: return ImGuiKey_GraveAccent;
		// case : return ImGuiKey_CapsLock;
		// case : return ImGuiKey_ScrollLock;
		// case : return ImGuiKey_NumLock;
		// case : return ImGuiKey_PrintScreen;
		case sf::Keyboard::Pause: return ImGuiKey_Pause;
		case sf::Keyboard::Numpad0: return ImGuiKey_Keypad0;
		case sf::Keyboard::Numpad1: return ImGuiKey_Keypad1;
		case sf::Keyboard::Numpad2: return ImGuiKey_Keypad2;
		case sf::Keyboard::Numpad3: return ImGuiKey_Keypad3;
		case sf::Keyboard::Numpad4: return ImGuiKey_Keypad4;
		case sf::Keyboard::Numpad5: return ImGuiKey_Keypad5;
		case sf::Keyboard::Numpad6: return ImGuiKey_Keypad6;
		case sf::Keyboard::Numpad7: return ImGuiKey_Keypad7;
		case sf::Keyboard::Numpad8: return ImGuiKey_Keypad8;
		case sf::Keyboard::Numpad9: return ImGuiKey_Keypad9;
		// case : return ImGuiKey_KeypadDecimal;
		case sf::Keyboard::Divide: return ImGuiKey_KeypadDivide;
		case sf::Keyboard::Multiply: return ImGuiKey_KeypadMultiply;
		case sf::Keyboard::Subtract: return ImGuiKey_KeypadSubtract;
		case sf::Keyboard::Add: return ImGuiKey_KeypadAdd;
		// case : return ImGuiKey_KeypadEnter;
		// case : return ImGuiKey_KeypadEqual;
		case sf::Keyboard::LControl: return ImGuiKey_LeftCtrl;
		case sf::Keyboard::LShift: return ImGuiKey_LeftShift;
		case sf::Keyboard::LAlt: return ImGuiKey_LeftAlt;
		case sf::Keyboard::LSystem: return ImGuiKey_LeftSuper;
		case sf::Keyboard::RControl: return ImGuiKey_RightCtrl;
		case sf::Keyboard::RShift: return ImGuiKey_RightShift;
		case sf::Keyboard::RAlt: return ImGuiKey_RightAlt;
		case sf::Keyboard::RSystem: return ImGuiKey_RightSuper;
		case sf::Keyboard::Menu: return ImGuiKey_Menu;
		case sf::Keyboard::Num0: return ImGuiKey_0;
		case sf::Keyboard::Num1: return ImGuiKey_1;
		case sf::Keyboard::Num2: return ImGuiKey_2;
		case sf::Keyboard::Num3: return ImGuiKey_3;
		case sf::Keyboard::Num4: return ImGuiKey_4;
		case sf::Keyboard::Num5: return ImGuiKey_5;
		case sf::Keyboard::Num6: return ImGuiKey_6;
		case sf::Keyboard::Num7: return ImGuiKey_7;
		case sf::Keyboard::Num8: return ImGuiKey_8;
		case sf::Keyboard::Num9: return ImGuiKey_9;
		...
		case sf::Keyboard::F1: return ImGuiKey_F1;
		case sf::Keyboard::F2: return ImGuiKey_F2;
		case sf::Keyboard::F3: return ImGuiKey_F3;
		case sf::Keyboard::F4: return ImGuiKey_F4;
		case sf::Keyboard::F5: return ImGuiKey_F5;
		case sf::Keyboard::F6: return ImGuiKey_F6;
		case sf::Keyboard::F7: return ImGuiKey_F7;
		case sf::Keyboard::F8: return ImGuiKey_F8;
		case sf::Keyboard::F9: return ImGuiKey_F9;
		case sf::Keyboard::F10: return ImGuiKey_F10;
		case sf::Keyboard::F11: return ImGuiKey_F11;
		case sf::Keyboard::F12: return ImGuiKey_F12;
		default: break;
		}
	...
	ImGuiKey keycodeToImGuiMod(sf::Keyboard::Key code)
	{
		...
		case sf::Keyboard::RControl: return ImGuiKey_ModCtrl;
		case sf::Keyboard::LShift:
		case sf::Keyboard::RShift: return ImGuiKey_ModShift;
		case sf::Keyboard::LAlt:
		case sf::Keyboard::RAlt: return ImGuiKey_ModAlt;
		case sf::Keyboard::LSystem:
		case sf::Keyboard::RSystem: return ImGuiKey_ModSuper;
		default: break;
		}
		return ImGuiKey_None;
	}
